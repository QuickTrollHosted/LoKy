...
const long Vset_TIC = 3333; // The voltage set for the supercapacitor
...
void Check_SupCapa() {
  ...
  Serial.print("Checking Voltage regulated from TIC... "); Serial.print(VccTIC/1000);Serial.println(" Volts");
...
//    loky_data[22] = 0x06;       //Select data_type = 6 --> PTEC, size 2 bytes from TTN
//    loky_data[23] = pt >> 8;
//    loky_data[24] = pt & 0xFF;
